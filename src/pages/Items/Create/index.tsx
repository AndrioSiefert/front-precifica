            ...
            <form onSubmit={handleSubmit} className='grid grid-cols-1 gap-4 lg:grid-cols-2'>
                ...
                <div className='rounded-3xl border border-slate-200 bg-white p-4 shadow-lg shadow-slate-200/60'>
                    ...
                    <div className='mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2'>
                        ...
                        <div>
                            <label className='block text-xs text-slate-500'>Preço de venda manual (R$)</label>
                            <input
                    ...
                    {created ? (
                        <div className='mt-3 rounded-lg border border-emerald-100 bg-emerald-50 p-3'>
                            ...
                            <div className='mt-2 flex flex-wrap gap-2'>
                                <Link to='/items' className='rounded-xl border border-slate-300 bg-slate-200 px-4 py-2 text-sm font-semibold text-slate-900 shadow-sm hover:bg-slate-300'>
                                    Ir para listagem
                                </Link>
                                {created?.photoUrl ? (
                                    <a
